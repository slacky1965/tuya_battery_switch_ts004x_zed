...
#### Почему при биндинге может не срабатывать, хотя все работает?

Иногда действительно, мы нажимаем на кнопку и ... ничего не происходит. Небольшие проверки со снифером выявили такую закономерность, если, например берем команды `OnOff`, послана команда и устройство реагирует на эту команду, то был ответ на команду. Но случается, что команду отправили и снифер это подтверждает, а ответа от устройства нет. Вот в таком случае устройство не отрабатывает должным образом. Почему так происходит сложно сказать, но судя по сниферу, устройство просто не "услышало" команду. Кто виноват и что делать - извечный вопрос ...
