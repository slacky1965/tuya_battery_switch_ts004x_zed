...
Привычный репортинг есть только у батарейки и все равно его пришлось немного модифицировать (в угоду сбережения заряда батарейки). Cчитывание показаний батарейки и отправка репорта зависят от настройки `Max rep interval`. **Чтобы принудительно отправить репортинг батарейки, нужно 4 раза подряд нажать на любую кнопку**
