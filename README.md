...
Привычный репортинг есть только у бетарейки и все равно его пришлось немного модифицировать (в угоду сбережения заряда батарейки). В пульте считывание батарейки и отправку репорта зависит зависит от настройки `Max rep interval`.
